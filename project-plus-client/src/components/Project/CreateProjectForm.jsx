      ...
      <Form {...form}>
          ...
          render={({ field }) => (
            <FormItem  className="border border-primary rounded-sm">
              <Select onValueChange={field.onChange} defaultValue={field.value?.toLowerCase()}>
                <FormControl>
                  <SelectTrigger>
                    <SelectValue className="placeholder-color" placeholder="Category"/>
                  </SelectTrigger>
                </FormControl>
                <SelectContent>
                  {
                    ...
                    key={cat} 
                    value={cat.toLowerCase()}>{cat}</SelectItem>
                    )
                  }
                </SelectContent>
              </Select>
        ...
        />
          <DialogClose>
            {
              isPlusMember?
              <Button type="submit" className="w-full py-5 mt-3">Create</Button>
              :
              <div>
                <span>you can create only 3 project with free plan, please upgrade to Plus member</span>
              </div>
            }
          </DialogClose>
        </form>
