...
function ProjectDetails() {
  ...
  return (
    <>
      {project.loading || project.projectDetails === null ? (
        <h1>Loading...</h1>
      ) : (
          ...
          <div className="lg:flex gap-5 justify-between pb-4">
            <ScrollArea className="h-screen lg:w-[69%] pr-2">
              <div className="pb-10 w-full">
                <h1 className="pb-5 font-bold text-2xl font-mono">
                ...
                <div className="space-y-5 pb-10">
                  ...
                  <div className="flex">
                    ...
                    <span className="font-semibold">
                      {project.projectDetails.owner.fullName.toUpperCase()}
                    </span>
                  </div>
                  <div className="flex">
                    <span className="w-36">Category:</span>
                    <span className="font-semibold">
                      {project.projectDetails.category.toUpperCase()}
                    </span>
                  </div>
                  <div className="flex">
                    ...
                    <div>
                      <Dialog>
                        ...
                        <DialogContent>
                          ...
                          />
                          <DialogDescription>
                            Please fill valid email address to invite user
                          </DialogDescription>
                        </DialogContent>
                      </Dialog>
                    </div>
