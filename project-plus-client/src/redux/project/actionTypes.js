...
export const SEND_PROJECT_INVITATION_REQUEST =
  "SEND_PROJECT_INVITATION_REQUEST";
export const SEND_PROJECT_INVITATION_SUCCESS =
  "SEND_PROJECT_INVITATION_SUCCESS";
export const SEND_PROJECT_INVITATION_FAILURE =
  "SEND_PROJECT_INVITATION_FAILURE";

export const ACCEPT_PROJECT_INVITATION_REQUEST =
  "ACCEPT_PROJECT_INVITATION_REQUEST";
export const ACCEPT_PROJECT_INVITATION_SUCCESS =
  "ACCEPT_PROJECT_INVITATION_SUCCESS";
export const ACCEPT_PROJECT_INVITATION_FAILURE =
